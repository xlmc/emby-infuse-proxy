...
function es(n, e, r) {
  ...
  return !t || !idOk.test(String(e || "")) || !/^(artwork|seasons|meta2)$/.test(String(r || "")) ? null : new Request(`https://infuse-series-context-cache.invalid/${encodeURIComponent(t)}/${encodeURIComponent(e)}/${r}`);
}
...
function respCachePlan(n) {
  ...
  return { req: new Request(`https://infuse-resp-cache.invalid${p}${q}`), ttl };
}
